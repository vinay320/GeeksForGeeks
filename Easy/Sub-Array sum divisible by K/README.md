<h2><a href="https://practice.geeksforgeeks.org/problems/sub-array-sum-divisible-by-k2617/1?utm_source=gfg&utm_medium=article&utm_campaign=bottom_sticky_on_article">Sub-Array sum divisible by K</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">You are given an array <strong>A</strong> of <strong>N</strong> positive and/or negative integers and a value <strong>K</strong>. The task is to find the count of all sub-arrays whose sum is divisible by K.</span></p>
