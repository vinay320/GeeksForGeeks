<h2><a href="https://practice.geeksforgeeks.org/problems/minimum-element-in-bst/1?page=1&status[]=unsolved&category[]=Tree&sortBy=submissions">Minimum element in BST</a></h2><h3>Difficulty Level : Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given a <strong>Binary Search Tree</strong>. The task is to find the minimum element in this given BST. </span></p>
